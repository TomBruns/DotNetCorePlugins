...
namespace User
{
	...
	{
		public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"User\",\"fields\":[{\"name\":\"name\",\"type\"" +
				":\"string\"},{\"name\":\"favorite_number\",\"type\":[\"int\",\"null\"]},{\"name\":\"favorite_co" +
				"lor\",\"type\":[\"string\",\"null\"]}]}");

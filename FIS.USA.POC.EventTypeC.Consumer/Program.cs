...
using FIS.USA.POC.EventTypeC.Plugin;
...
namespace FIS.USA.POC.EventTypeC.Consumer
{
    ...
    class Program
    {
        ...
        {
            string topicName = EventTypeCPublisher.TOPIC_NAME;

            using var schemaRegistry = new CachedSchemaRegistryClient(_schemaRegistryConfig);
            using var consumer = new ConsumerBuilder<EventKey, EventTypeCBody>(_consumerConfig)
                                        .SetKeyDeserializer(new AvroDeserializer<EventKey>(schemaRegistry).AsSyncOverAsync())
                                        .SetValueDeserializer(new AvroDeserializer<EventTypeCBody>(schemaRegistry).AsSyncOverAsync())
